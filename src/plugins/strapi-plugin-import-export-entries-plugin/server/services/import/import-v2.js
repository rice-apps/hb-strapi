 ...
 */
const importDataV2 = (fileContent, { slug: slugArg, user, idField, alias }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (const slug of contentTypeSlugs) {
        const res = yield importContentTypeSlug(data[slug], Object.assign(Object.assign({ slug: slug, user }, (slug === slugArg ? { idField } : {})), { alias, importStage: 'simpleAttributes', fileIdToDbId,
            componentsDataStore }));
        failures.push(...res.failures);
    }
...
const importContentTypeSlug = (slugEntries, { slug, user, idField, alias, importStage, fileIdToDbId, componentsDataStore, }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (let [fileId, fileEntry] of fileEntries) {
        try {
            yield updateOrCreate(user, slug, fileId, fileEntry, idField, alias, { importStage, fileIdToDbId, componentsDataStore });
        }
        catch (err) {
            strapi.log.error(err);
            failures.push({ error: err, data: fileEntry });
...
const updateOrCreate = (user, slug, fileId, fileEntryArg, idFieldArg, aliasArg, { importStage, fileIdToDbId, componentsDataStore }) => __awaiter(void 0, void 0, void 0, function* () {
    var _c, _d, _e, _f;
    const schema = (0, models_1.getModel)(slug);
    ...
    const aliasField = aliasArg || ((_f = (_e = schema === null || schema === void 0 ? void 0 : schema.pluginOptions) === null || _e === void 0 ? void 0 : _e['import-export-entries']) === null || _f === void 0 ? void 0 : _f.alias);
    ...
    if (importStage == 'simpleAttributes') {
        ...
        if (aliasField) {
            fileEntry = (0, mapKeys_1.default)(fileEntry, (_, key) => aliasField[key] || key);
        }
...
const updateOrCreateCollectionTypeEntry = (user, slug, fileId, fileEntry, { idField, importStage, fileIdToDbId }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!((_h = (_g = schema.pluginOptions) === null || _g === void 0 ? void 0 : _g.i18n) === null || _h === void 0 ? void 0 : _h.localized)) {
        ...
        if (isDatumInDefaultLocale) {
            ...
            if (dbEntry) {
                ...
                dbEntryDefaultLocaleId = ((_j = localizedEntries.find((e) => e.locale === defaultLocale)) === null || _j === void 0 ? void 0 : _j.id) || null;
                ...
                while (idx < fileLocalizationsIds.length && !dbEntryDefaultLocaleId && !dbEntry) {
                    ...
                    if (!dbEntryDefaultLocaleId) {
                        dbEntryDefaultLocaleId = ((_k = localizedEntries.find((e) => e.locale === defaultLocale)) === null || _k === void 0 ? void 0 : _k.id) || null;
                    }
                    if (!dbEntry) {
                        dbEntry = localizedEntries.find((e) => e.locale === fileEntry.locale) || null;
                    }
...
const updateOrCreateSingleTypeEntry = (user, slug, fileId, fileEntry, { importStage, fileIdToDbId }) => __awaiter(void 0, void 0, void 0, function* () {
    var _l, _m;
    const schema = (0, models_1.getModel)(slug);
    if (!((_m = (_l = schema.pluginOptions) === null || _l === void 0 ? void 0 : _l.i18n) === null || _m === void 0 ? void 0 : _m.localized)) {
